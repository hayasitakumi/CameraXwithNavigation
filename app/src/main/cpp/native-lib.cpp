...
Java_com_example_cameraxwithnavigation_ui_camera_CameraFragment_recog(
        JNIEnv *env,
        jobject instance,
        jlong imageAddr,
        jintArray  RetObj
    ...
    string ty =  type2str( image0.type() );
    __android_log_print(ANDROID_LOG_VERBOSE, "develop_mat", "Matrix: %s %dx%d \n", ty.c_str(), image0.cols, image0.rows);
